...
Elm.FlickrViewer = Elm.FlickrViewer || {};
Elm.FlickrViewer.make = function (_elm) {
   "use strict";
   _elm.FlickrViewer = _elm.FlickrViewer || {};
   if (_elm.FlickrViewer.values)
   return _elm.FlickrViewer.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Photo = Elm.Photo.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $Task = Elm.Task.make(_elm);
   var emptyPhoto = A7($Photo.Photo,
   "",
   0,
   "",
   "",
   ...
   "",
   "");
   var flickrUrl = function (term) {
      return A2($Http.url,
      "https://api.flickr.com/services/rest/",
      _L.fromArray([{ctor: "_Tuple2"
                    ,_0: "api_key"
                    ,_1: "934910a2c34c06b6b167e1589069c274"}
                   ,{ctor: "_Tuple2"
                    ,_0: "method"
                    ,_1: "flickr.tags.getClusterPhotos"}
                   ,{ctor: "_Tuple2"
                    ,_0: "tag"
                    ,_1: term}
                   ,{ctor: "_Tuple2"
   ...
   var photoDecoder = A8($Json$Decode.object7,
   $Photo.Photo,
   A2($Json$Decode._op[":="],
   "id",
   $Json$Decode.string),
   ...
   "username",
   $Json$Decode.string));
   var decodeResponse = A2($Json$Decode.at,
   _L.fromArray(["photos"
                ,"photo"]),
   $Json$Decode.list(photoDecoder));
   var LoadFull = function (a) {
      return {ctor: "LoadFull"
             ,_0: a};
   };
   var thumbnailLink = F2(function (address,
   photo) {
      return A2($Html.a,
      ...
      _L.fromArray([$Html$Attributes.src($Photo.thumbnailUrl(photo))]),
      _L.fromArray([]))]));
   });
   var ReturnResults = function (a) {
      return {ctor: "ReturnResults"
             ,_0: a};
   };
   var getPhotos = function (searchTerm) {
      return $Effects.task($Task.map(ReturnResults)($Task.toMaybe(A2($Http.get,
      decodeResponse,
      flickrUrl(searchTerm)))));
   };
   var RunSearch = {ctor: "RunSearch"};
   var SearchTerm = function (a) {
      return {ctor: "SearchTerm"
             ,_0: a};
   };
   var view = F2(function (address,
   model) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("mui-container")]),
      _L.fromArray([A2($Html.h1,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text("Elm Flicker Viewer")]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("mui-panel")]),
                   _L.fromArray([A2($Html.div,
                                _L.fromArray([]),
                                _L.fromArray([A2($Html.form,
                                _L.fromArray([A2($Html$Events.onSubmit,
                                             address,
                                             RunSearch)
                                             ,$Html$Attributes.action("javascript:none")
                                             ,$Html$Attributes.$class("mui-form-inline mui-form-group")]),
                                _L.fromArray([A2($Html.input,
                                             _L.fromArray([$Html$Attributes.id("search")
                                                          ...
                                                          ,$Html$Attributes.$class("mui-form-control")
                                                          ,$Html$Attributes.placeholder("Search")]),
                                             _L.fromArray([]))
                                             ,A2($Html.button,
                                             _L.fromArray([$Html$Attributes.id("runSearch")
                                                          ,$Html$Attributes.$class("mui-btn mui-btn-primary")
                                                          ,$Html$Attributes.type$("submit")]),
                                             _L.fromArray([$Html.text("Search")]))]))]))
                                ,A2($Html.div,
                                _L.fromArray([]),
                                _L.fromArray([A2($Html.div,
                                _L.fromArray([$Html$Attributes.$class("mui-row")]),
                                _L.fromArray([A2($Html.div,
                                             _L.fromArray([$Html$Attributes.$class("mui-col-md-8")]),
                                             _L.fromArray([A2($Html.img,
                                             _L.fromArray([$Html$Attributes.src($Photo.fullSizeUrl(model.selectedImage))
                                                          ,$Html$Attributes.classList(_L.fromArray([{ctor: "_Tuple2"
                                                                                                    ,_0: "show"
                                                                                                    ,_1: model.hasPhoto}]))
                                                          ,$Html$Attributes.id("fullSize")]),
                                             _L.fromArray([]))]))
                                             ,A2($Html.div,
                                             _L.fromArray([$Html$Attributes.id("thumbs")
                                                          ,$Html$Attributes.$class("mui-col-md-4")]),
                                             A2($List.map,
                                             thumbnailLink(address),
                                             model.results))]))]))]))]));
   });
   ...
   _elm.FlickrViewer.values = {_op: _op
                              ,Model: Model
                              ,init: init
...
Elm.Main.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $FlickrViewer = Elm.FlickrViewer.make(_elm),
   $Html = Elm.Html.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   var app = $StartApp.start({_: {}
                             ,init: $FlickrViewer.init("")
                             ,inputs: _L.fromArray([])
                             ,update: $FlickrViewer.update
                             ,view: $FlickrViewer.view});
   var main = app.html;
...
Elm.Photo = Elm.Photo || {};
Elm.Photo.make = function (_elm) {
   "use strict";
   _elm.Photo = _elm.Photo || {};
   if (_elm.Photo.values)
   return _elm.Photo.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var baseUrl = function (photo) {
      return A2($Basics._op["++"],
      "http://farm",
      A2($Basics._op["++"],
      $Basics.toString(photo.farm),
      A2($Basics._op["++"],
      ".staticflickr.com/",
      A2($Basics._op["++"],
      photo.server,
