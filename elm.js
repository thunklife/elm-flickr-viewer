...
Elm.Main.make = function (_elm) {
   ...
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $SearchBar = Elm.SearchBar.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $StartApp$Simple = Elm.StartApp.Simple.make(_elm);
   var main = $StartApp$Simple.start({_: {}
                                     ,model: {_: {}
                                             ,results: _L.fromArray([])
                                             ,searchTerm: ""}
                                     ,update: $SearchBar.update
                                     ,view: $SearchBar.view});
...
Elm.SearchBar = Elm.SearchBar || {};
Elm.SearchBar.make = function (_elm) {
   "use strict";
   _elm.SearchBar = _elm.SearchBar || {};
   if (_elm.SearchBar.values)
   return _elm.SearchBar.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   model) {
      ...
      _L.fromArray([A2($Html.input,
                   ...
                   ,A2($Html.p,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text(model.searchTerm)]))]));
   });
